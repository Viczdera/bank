...
type Store interface {
	Querier // Querier interface is implemented by the Queries struct generated by sqlc
	TransferTx(ctx context.Context, arg TransferTxParams) (TransferTxResult, error)
}

// SQLStore implements Store interface
// It provides all functions to execute a transaction in a db
// It embeds the Queries struct generated by sqlc, which contains all the query methods
...
// It takes a database connection and returns a Store interface
